...
import { FaBtc, FaPaypal, FaCreditCard, FaBusinessTime, FaUniversity, FaChartLine } from 'react-icons/fa';
import { RiVisaLine, RiBankLine } from 'react-icons/ri';
import { GiCash } from 'react-icons/gi';
import { MdAdd, MdVerifiedUser, MdSavings, MdAccountBalance } from 'react-icons/md';
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 py-10 gap-6">
            {data?.map((acc, index) => (
              ...
              >
                ...
                <div>{ICONS[acc?.type_name?.toLowerCase()] || ICONS.default}</div>
                <div className="space-y-2 w-full">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-sm outline-none text-violet-600 hover:underline dark:text-gray-500"
                    >
                      Add Money
                    </button>
                  </div>
